...
.method public constructor <init>(Landroid/content/Context;Landroid/view/GestureDetector$OnGestureListener;Landroid/os/Handler;)V
    ...
    iput-object v0, p0, Landroid/support/v4/view/f$b;->m:Landroid/os/Handler;
...
.method private a(Landroid/content/Context;)V
    ...
    iput-boolean v0, p0, Landroid/support/v4/view/f$b;->w:Z
...
.method private a(Landroid/view/MotionEvent;Landroid/view/MotionEvent;Landroid/view/MotionEvent;)Z
    ...
    .line 444
    iget-boolean v1, p0, Landroid/support/v4/view/f$b;->p:Z
...
.method private b()V
    ...
    .line 414
    iget-object v0, p0, Landroid/support/v4/view/f$b;->m:Landroid/os/Handler;
    ...
    .line 417
    iget-object v0, p0, Landroid/support/v4/view/f$b;->x:Landroid/view/VelocityTracker;
    ...
    iput-object v0, p0, Landroid/support/v4/view/f$b;->x:Landroid/view/VelocityTracker;
    ...
    .line 421
    iput-boolean v2, p0, Landroid/support/v4/view/f$b;->o:Z

    .line 422
    iput-boolean v2, p0, Landroid/support/v4/view/f$b;->p:Z

    .line 423
    iput-boolean v2, p0, Landroid/support/v4/view/f$b;->d:Z

    .line 424
    iget-boolean v0, p0, Landroid/support/v4/view/f$b;->n:Z

    if-eqz v0, :cond_0

    .line 425
    iput-boolean v2, p0, Landroid/support/v4/view/f$b;->n:Z
...
.method a()V
    ...
    iput-boolean v0, p0, Landroid/support/v4/view/f$b;->n:Z
...
.method public a(Landroid/view/MotionEvent;)Z
    ...
    .line 255
    :pswitch_1
    iput v2, p0, Landroid/support/v4/view/f$b;->s:F

    iput v2, p0, Landroid/support/v4/view/f$b;->u:F

    .line 256
    iput v1, p0, Landroid/support/v4/view/f$b;->t:F

    iput v1, p0, Landroid/support/v4/view/f$b;->v:F
    ...
    .line 270
    iget-object v2, p0, Landroid/support/v4/view/f$b;->x:Landroid/view/VelocityTracker;
    ...
    .line 271
    iget-object v5, p0, Landroid/support/v4/view/f$b;->x:Landroid/view/VelocityTracker;
    ...
    .line 276
    iget-object v8, p0, Landroid/support/v4/view/f$b;->x:Landroid/view/VelocityTracker;
    ...
    .line 277
    iget-object v9, p0, Landroid/support/v4/view/f$b;->x:Landroid/view/VelocityTracker;
    ...
    iget-object v4, p0, Landroid/support/v4/view/f$b;->m:Landroid/os/Handler;
    ...
    iget-object v4, p0, Landroid/support/v4/view/f$b;->q:Landroid/view/MotionEvent;
    ...
    .line 312
    iput-boolean v8, p0, Landroid/support/v4/view/f$b;->o:Z

    .line 313
    iput-boolean v8, p0, Landroid/support/v4/view/f$b;->p:Z

    .line 314
    iput-boolean v8, p0, Landroid/support/v4/view/f$b;->c:Z

    .line 315
    iput-boolean v3, p0, Landroid/support/v4/view/f$b;->n:Z

    .line 316
    iput-boolean v3, p0, Landroid/support/v4/view/f$b;->d:Z

    .line 318
    iget-boolean v1, p0, Landroid/support/v4/view/f$b;->w:Z

    if-eqz v1, :cond_b

    .line 319
    iget-object v1, p0, Landroid/support/v4/view/f$b;->m:Landroid/os/Handler;
    ...
    .line 332
    iget v0, p0, Landroid/support/v4/view/f$b;->s:F

    sub-float/2addr v0, v2

    .line 333
    iget v4, p0, Landroid/support/v4/view/f$b;->t:F
    ...
    .line 337
    :cond_e
    iget-boolean v5, p0, Landroid/support/v4/view/f$b;->o:Z

    if-eqz v5, :cond_10

    .line 338
    iget v5, p0, Landroid/support/v4/view/f$b;->u:F
    ...
    .line 339
    iget v6, p0, Landroid/support/v4/view/f$b;->v:F
    ...
    .line 345
    iput-boolean v3, p0, Landroid/support/v4/view/f$b;->o:Z
    ...
    .line 351
    iput-boolean v3, p0, Landroid/support/v4/view/f$b;->p:Z
    ...
    :cond_12
    :goto_9
    iget-object v2, p0, Landroid/support/v4/view/f$b;->q:Landroid/view/MotionEvent;
    ...
    .line 392
    :cond_13
    iput-object v1, p0, Landroid/support/v4/view/f$b;->q:Landroid/view/MotionEvent;

    .line 393
    iget-object v1, p0, Landroid/support/v4/view/f$b;->x:Landroid/view/VelocityTracker;
    ...
    iput-object v1, p0, Landroid/support/v4/view/f$b;->x:Landroid/view/VelocityTracker;
    ...
    .line 369
    :cond_16
    iget-boolean v0, p0, Landroid/support/v4/view/f$b;->o:Z
    ...
    .line 406
    :pswitch_6
    invoke-direct {p0}, Landroid/support/v4/view/f$b;->b()V
