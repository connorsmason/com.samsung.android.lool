...
.method public constructor <init>(Landroid/support/v4/app/f;)V
    ...
    .line 47
    iget-object v1, p1, Landroid/support/v4/app/f;->b:Ljava/util/ArrayList;
    ...
    .line 50
    iget-boolean v1, p1, Landroid/support/v4/app/f;->i:Z
    ...
    .line 56
    iget-object v0, p1, Landroid/support/v4/app/f;->b:Ljava/util/ArrayList;
    ...
    iget v6, v0, Landroid/support/v4/app/f$a;->a:I
    ...
    iget v6, v0, Landroid/support/v4/app/f$a;->d:I
    ...
    iget v6, v0, Landroid/support/v4/app/f$a;->e:I
    ...
    .line 64
    :cond_2
    iget v0, p1, Landroid/support/v4/app/f;->g:I

    iput v0, p0, Landroid/support/v4/app/BackStackState;->b:I

    .line 65
    iget v0, p1, Landroid/support/v4/app/f;->h:I

    iput v0, p0, Landroid/support/v4/app/BackStackState;->c:I

    .line 66
    iget-object v0, p1, Landroid/support/v4/app/f;->k:Ljava/lang/String;

    iput-object v0, p0, Landroid/support/v4/app/BackStackState;->d:Ljava/lang/String;

    .line 67
    iget v0, p1, Landroid/support/v4/app/f;->m:I

    iput v0, p0, Landroid/support/v4/app/BackStackState;->e:I

    .line 68
    iget v0, p1, Landroid/support/v4/app/f;->n:I

    iput v0, p0, Landroid/support/v4/app/BackStackState;->f:I

    .line 69
    iget-object v0, p1, Landroid/support/v4/app/f;->o:Ljava/lang/CharSequence;
    ...
    .line 71
    iget-object v0, p1, Landroid/support/v4/app/f;->q:Ljava/lang/CharSequence;

    iput-object v0, p0, Landroid/support/v4/app/BackStackState;->i:Ljava/lang/CharSequence;

    .line 72
    iget-object v0, p1, Landroid/support/v4/app/f;->r:Ljava/util/ArrayList;

    iput-object v0, p0, Landroid/support/v4/app/BackStackState;->j:Ljava/util/ArrayList;

    .line 73
    iget-object v0, p1, Landroid/support/v4/app/f;->s:Ljava/util/ArrayList;

    iput-object v0, p0, Landroid/support/v4/app/BackStackState;->k:Ljava/util/ArrayList;

    .line 74
    iget-boolean v0, p1, Landroid/support/v4/app/f;->t:Z
...
# virtual methods
.method public a(Landroid/support/v4/app/t;)Landroid/support/v4/app/f;
    .locals 8
    ...
    invoke-direct {v3, p1}, Landroid/support/v4/app/f;-><init>(Landroid/support/v4/app/t;)V
    ...
    .line 97
    new-instance v4, Landroid/support/v4/app/f$a;

    invoke-direct {v4}, Landroid/support/v4/app/f$a;-><init>()V
    ...
    iput v0, v4, Landroid/support/v4/app/f$a;->a:I
    ...
    .line 103
    iget-object v5, p1, Landroid/support/v4/app/t;->f:Landroid/util/SparseArray;
    ...
    .line 104
    iput-object v0, v4, Landroid/support/v4/app/f$a;->b:Landroid/support/v4/app/Fragment;
    ...
    iput v0, v4, Landroid/support/v4/app/f$a;->c:I
    ...
    iput v0, v4, Landroid/support/v4/app/f$a;->d:I
    ...
    iput v0, v4, Landroid/support/v4/app/f$a;->e:I
    ...
    iput v0, v4, Landroid/support/v4/app/f$a;->f:I

    .line 112
    iget v0, v4, Landroid/support/v4/app/f$a;->c:I

    iput v0, v3, Landroid/support/v4/app/f;->c:I

    .line 113
    iget v0, v4, Landroid/support/v4/app/f$a;->d:I

    iput v0, v3, Landroid/support/v4/app/f;->d:I

    .line 114
    iget v0, v4, Landroid/support/v4/app/f$a;->e:I

    iput v0, v3, Landroid/support/v4/app/f;->e:I

    .line 115
    iget v0, v4, Landroid/support/v4/app/f$a;->f:I

    iput v0, v3, Landroid/support/v4/app/f;->f:I

    .line 116
    invoke-virtual {v3, v4}, Landroid/support/v4/app/f;->a(Landroid/support/v4/app/f$a;)V
    ...
    iput v0, v3, Landroid/support/v4/app/f;->g:I

    .line 120
    iget v0, p0, Landroid/support/v4/app/BackStackState;->c:I

    iput v0, v3, Landroid/support/v4/app/f;->h:I

    .line 121
    iget-object v0, p0, Landroid/support/v4/app/BackStackState;->d:Ljava/lang/String;

    iput-object v0, v3, Landroid/support/v4/app/f;->k:Ljava/lang/String;

    .line 122
    iget v0, p0, Landroid/support/v4/app/BackStackState;->e:I

    iput v0, v3, Landroid/support/v4/app/f;->m:I

    .line 123
    iput-boolean v7, v3, Landroid/support/v4/app/f;->i:Z

    .line 124
    iget v0, p0, Landroid/support/v4/app/BackStackState;->f:I

    iput v0, v3, Landroid/support/v4/app/f;->n:I

    .line 125
    iget-object v0, p0, Landroid/support/v4/app/BackStackState;->g:Ljava/lang/CharSequence;

    iput-object v0, v3, Landroid/support/v4/app/f;->o:Ljava/lang/CharSequence;

    .line 126
    iget v0, p0, Landroid/support/v4/app/BackStackState;->h:I

    iput v0, v3, Landroid/support/v4/app/f;->p:I

    .line 127
    iget-object v0, p0, Landroid/support/v4/app/BackStackState;->i:Ljava/lang/CharSequence;

    iput-object v0, v3, Landroid/support/v4/app/f;->q:Ljava/lang/CharSequence;

    .line 128
    iget-object v0, p0, Landroid/support/v4/app/BackStackState;->j:Ljava/util/ArrayList;

    iput-object v0, v3, Landroid/support/v4/app/f;->r:Ljava/util/ArrayList;

    .line 129
    iget-object v0, p0, Landroid/support/v4/app/BackStackState;->k:Ljava/util/ArrayList;

    iput-object v0, v3, Landroid/support/v4/app/f;->s:Ljava/util/ArrayList;

    .line 130
    iget-boolean v0, p0, Landroid/support/v4/app/BackStackState;->l:Z

    iput-boolean v0, v3, Landroid/support/v4/app/f;->t:Z

    .line 131
    invoke-virtual {v3, v7}, Landroid/support/v4/app/f;->a(I)V
