...
.field mListener:Landroid/support/v4/view/ar;

.field private final mProxyListener:Landroid/support/v4/view/as;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Landroid/support/v7/view/ViewPropertyAnimatorCompatSet;->mProxyListener:Landroid/support/v4/view/as;
...
.method public play(Landroid/support/v4/view/ao;)Landroid/support/v7/view/ViewPropertyAnimatorCompatSet;
    .locals 1
...
.method public playSequentially(Landroid/support/v4/view/ao;Landroid/support/v4/view/ao;)Landroid/support/v7/view/ViewPropertyAnimatorCompatSet;
    .locals 2
    ...
    .line 61
    invoke-virtual {p1}, Landroid/support/v4/view/ao;->a()J

    move-result-wide v0

    invoke-virtual {p2, v0, v1}, Landroid/support/v4/view/ao;->b(J)Landroid/support/v4/view/ao;
...
.method public setListener(Landroid/support/v4/view/ar;)Landroid/support/v7/view/ViewPropertyAnimatorCompatSet;
    .locals 1
    ...
    .line 114
    iput-object p1, p0, Landroid/support/v7/view/ViewPropertyAnimatorCompatSet;->mListener:Landroid/support/v4/view/ar;
...
.method public start()V
    ...
    invoke-virtual {v0, v2, v3}, Landroid/support/v4/view/ao;->a(J)Landroid/support/v4/view/ao;
    ...
    invoke-virtual {v0, v2}, Landroid/support/v4/view/ao;->a(Landroid/view/animation/Interpolator;)Landroid/support/v4/view/ao;

    .line 75
    :cond_2
    iget-object v2, p0, Landroid/support/v7/view/ViewPropertyAnimatorCompatSet;->mListener:Landroid/support/v4/view/ar;

    if-eqz v2, :cond_3

    .line 76
    iget-object v2, p0, Landroid/support/v7/view/ViewPropertyAnimatorCompatSet;->mProxyListener:Landroid/support/v4/view/as;

    invoke-virtual {v0, v2}, Landroid/support/v4/view/ao;->a(Landroid/support/v4/view/ar;)Landroid/support/v4/view/ao;

    .line 78
    :cond_3
    invoke-virtual {v0}, Landroid/support/v4/view/ao;->c()V
