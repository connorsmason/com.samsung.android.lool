...
.method static synthetic access$300(Landroid/support/v7/preference/PreferenceFragmentCompat;)I
    ...
    .prologue
    .line 128
    iget v0, p0, Landroid/support/v7/preference/PreferenceFragmentCompat;->mRoundedCornerType:I
...
.method static synthetic access$400(Landroid/support/v7/preference/PreferenceFragmentCompat;)Landroid/support/v7/util/SeslSubheaderRoundedCorner;
    ...
    .prologue
    .line 128
    iget-object v0, p0, Landroid/support/v7/preference/PreferenceFragmentCompat;->mSeslSubheaderRoundedCorner:Landroid/support/v7/util/SeslSubheaderRoundedCorner;
...
.method static synthetic access$500(Landroid/support/v7/preference/PreferenceFragmentCompat;)Landroid/support/v7/util/SeslRoundedCorner;
    ...
    .prologue
    .line 128
    iget-object v0, p0, Landroid/support/v7/preference/PreferenceFragmentCompat;->mSeslRoundedCorner:Landroid/support/v7/util/SeslRoundedCorner;
...
.method static synthetic access$600(Landroid/support/v7/preference/PreferenceFragmentCompat;)Landroid/support/v7/util/SeslRoundedCorner;
    ...
    .prologue
    .line 128
    iget-object v0, p0, Landroid/support/v7/preference/PreferenceFragmentCompat;->mSeslStrokeListRoundedCorner:Landroid/support/v7/util/SeslRoundedCorner;
...
.method static synthetic access$700(Landroid/support/v7/preference/PreferenceFragmentCompat;)Landroid/support/v7/util/SeslRoundedCorner;
    ...
    .prologue
    .line 128
    iget-object v0, p0, Landroid/support/v7/preference/PreferenceFragmentCompat;->mSeslListRoundedCorner:Landroid/support/v7/util/SeslRoundedCorner;
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    .line 262
    invoke-virtual {p0}, Landroid/support/v7/preference/PreferenceFragmentCompat;->getActivity()Landroid/support/v4/app/n;

    move-result-object v1

    invoke-virtual {v1}, Landroid/support/v4/app/n;->getTheme()Landroid/content/res/Resources$Theme;
...
.method public onCreateView(Landroid/view/LayoutInflater;Landroid/view/ViewGroup;Landroid/os/Bundle;)Landroid/view/View;
    ...
    .line 313
    sget v3, Landroid/support/v7/preference/R$styleable;->PreferenceFragmentCompat_allowDividerAfterLastItem:I
    ...
    sget-object v6, Landroid/support/v7/preference/R$styleable;->View:[I

    const v7, 0x1010208

    const/4 v8, 0x0

    invoke-virtual {v0, v5, v6, v7, v8}, Landroid/content/Context;->obtainStyledAttributes(Landroid/util/AttributeSet;[III)Landroid/content/res/TypedArray;

    move-result-object v5

    .line 322
    sget v0, Landroid/support/v7/preference/R$styleable;->View_android_background:I
    ...
    iput v0, p0, Landroid/support/v7/preference/PreferenceFragmentCompat;->mSubheaderColor:I
    ...
    const-string v7, " sub header color = "

    invoke-virtual {v6, v7}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v6

    iget v7, p0, Landroid/support/v7/preference/PreferenceFragmentCompat;->mSubheaderColor:I
    ...
    invoke-virtual {v5}, Landroid/support/v4/app/n;->getTheme()Landroid/content/res/Resources$Theme;

    move-result-object v5

    sget v6, Landroid/support/v7/preference/R$attr;->preferenceTheme:I
    ...
    .line 349
    invoke-virtual {p0, v6, v0, p3}, Landroid/support/v7/preference/PreferenceFragmentCompat;->onCreateRecyclerView(Landroid/view/LayoutInflater;Landroid/view/ViewGroup;Landroid/os/Bundle;)Landroid/support/v7/widget/RecyclerView;
    ...
    .line 355
    :cond_2
    iput-object v6, p0, Landroid/support/v7/preference/PreferenceFragmentCompat;->mList:Landroid/support/v7/widget/RecyclerView;

    .line 357
    iget-object v8, p0, Landroid/support/v7/preference/PreferenceFragmentCompat;->mDividerDecoration:Landroid/support/v7/preference/PreferenceFragmentCompat$DividerDecoration;

    invoke-virtual {v6, v8}, Landroid/support/v7/widget/RecyclerView;->addItemDecoration(Landroid/support/v7/widget/RecyclerView$ItemDecoration;)V
    ...
    .line 362
    :cond_3
    iget-object v1, p0, Landroid/support/v7/preference/PreferenceFragmentCompat;->mDividerDecoration:Landroid/support/v7/preference/PreferenceFragmentCompat$DividerDecoration;

    invoke-virtual {v1, v3}, Landroid/support/v7/preference/PreferenceFragmentCompat$DividerDecoration;->setAllowDividerAfterLastItem(Z)V
    ...
    invoke-direct {v1, v2, v3}, Landroid/support/v7/util/SeslSubheaderRoundedCorner;-><init>(Landroid/content/Context;Z)V

    iput-object v1, p0, Landroid/support/v7/preference/PreferenceFragmentCompat;->mSeslSubheaderRoundedCorner:Landroid/support/v7/util/SeslSubheaderRoundedCorner;
    ...
    invoke-direct {v1, v5, v2}, Landroid/support/v7/util/SeslRoundedCorner;-><init>(Landroid/content/Context;Z)V

    iput-object v1, p0, Landroid/support/v7/preference/PreferenceFragmentCompat;->mSeslRoundedCorner:Landroid/support/v7/util/SeslRoundedCorner;

    .line 370
    sget v1, Landroid/support/v7/preference/R$color;->sesl_round_and_bgcolor_dark:I

    invoke-virtual {v4, v1}, Landroid/content/res/Resources;->getColor(I)I

    move-result v1

    iput v1, p0, Landroid/support/v7/preference/PreferenceFragmentCompat;->mSubheaderColor:I

    .line 372
    iget-object v1, p0, Landroid/support/v7/preference/PreferenceFragmentCompat;->mSeslSubheaderRoundedCorner:Landroid/support/v7/util/SeslSubheaderRoundedCorner;

    const/16 v2, 0xf

    iget v3, p0, Landroid/support/v7/preference/PreferenceFragmentCompat;->mSubheaderColor:I

    invoke-virtual {v1, v2, v3}, Landroid/support/v7/util/SeslSubheaderRoundedCorner;->setRoundedCornerColor(II)V

    .line 373
    iget-object v1, p0, Landroid/support/v7/preference/PreferenceFragmentCompat;->mSeslRoundedCorner:Landroid/support/v7/util/SeslRoundedCorner;

    const/16 v2, 0xf

    iget v3, p0, Landroid/support/v7/preference/PreferenceFragmentCompat;->mSubheaderColor:I

    invoke-virtual {v1, v2, v3}, Landroid/support/v7/util/SeslRoundedCorner;->setRoundedCornerColor(II)V

    .line 375
    const/4 v1, 0x0

    invoke-virtual {v6, v1}, Landroid/support/v7/widget/RecyclerView;->seslSetOutlineStrokeEnabled(Z)V
    ...
    invoke-virtual {v6, v1}, Landroid/support/v7/widget/RecyclerView;->seslSetFillBottomEnabled(Z)V

    .line 383
    iget v1, p0, Landroid/support/v7/preference/PreferenceFragmentCompat;->mSubheaderColor:I

    invoke-virtual {v6, v1}, Landroid/support/v7/widget/RecyclerView;->seslSetFillBottomColor(I)V
    ...
    invoke-direct {v1, v5, v2, v3}, Landroid/support/v7/util/SeslRoundedCorner;-><init>(Landroid/content/Context;ZZ)V

    iput-object v1, p0, Landroid/support/v7/preference/PreferenceFragmentCompat;->mSeslListRoundedCorner:Landroid/support/v7/util/SeslRoundedCorner;

    .line 385
    iget-object v1, p0, Landroid/support/v7/preference/PreferenceFragmentCompat;->mSeslListRoundedCorner:Landroid/support/v7/util/SeslRoundedCorner;
    ...
    invoke-direct {v1, v5}, Landroid/support/v7/util/SeslRoundedCorner;-><init>(Landroid/content/Context;)V

    iput-object v1, p0, Landroid/support/v7/preference/PreferenceFragmentCompat;->mSeslStrokeListRoundedCorner:Landroid/support/v7/util/SeslRoundedCorner;

    .line 389
    iget-object v1, p0, Landroid/support/v7/preference/PreferenceFragmentCompat;->mSeslStrokeListRoundedCorner:Landroid/support/v7/util/SeslRoundedCorner;
    ...
    invoke-direct {v1, v5}, Landroid/support/v7/util/SeslSubheaderRoundedCorner;-><init>(Landroid/content/Context;)V
...
.method public onDisplayPreferenceDialog(Landroid/support/v7/preference/Preference;)V
    ...
    .line 741
    :cond_2
    invoke-virtual {p0}, Landroid/support/v7/preference/PreferenceFragmentCompat;->getFragmentManager()Landroid/support/v4/app/s;
