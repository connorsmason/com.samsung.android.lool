...
.method public onApplyWindowInsets(Landroid/view/View;Landroid/support/v4/view/au;)Landroid/support/v4/view/au;
    ...
    .prologue
    .line 465
    invoke-virtual {p2}, Landroid/support/v4/view/au;->b()I
    ...
    .line 470
    invoke-virtual {p2}, Landroid/support/v4/view/au;->a()I

    move-result v0

    .line 472
    invoke-virtual {p2}, Landroid/support/v4/view/au;->c()I

    move-result v2

    .line 473
    invoke-virtual {p2}, Landroid/support/v4/view/au;->d()I

    move-result v3

    .line 469
    invoke-virtual {p2, v0, v1, v2, v3}, Landroid/support/v4/view/au;->a(IIII)Landroid/support/v4/view/au;
