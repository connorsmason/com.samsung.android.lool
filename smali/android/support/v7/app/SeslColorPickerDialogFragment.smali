...
.method public onClick(Landroid/content/DialogInterface;I)V
    ...
    .line 228
    iget-object v0, p0, Landroid/support/v7/app/SeslColorPickerDialogFragment;->mOnColorSetListener:Landroid/support/v7/app/SeslColorPickerDialogFragment$OnColorSetListener;

    if-eqz v0, :cond_0

    .line 229
    iget-object v0, p0, Landroid/support/v7/app/SeslColorPickerDialogFragment;->mCurrentColor:Ljava/lang/Integer;
    ...
    invoke-interface {v0, v1}, Landroid/support/v7/app/SeslColorPickerDialogFragment$OnColorSetListener;->onColorSet(I)V
...
.method public onCreateDialog(Landroid/os/Bundle;)Landroid/app/Dialog;
    ...
    .line 214
    invoke-virtual {p0}, Landroid/support/v7/app/SeslColorPickerDialogFragment;->getActivity()Landroid/support/v4/app/n;

    move-result-object v2

    sget v3, Landroid/support/v7/appcompat/R$style;->ThemeOverlay_AppCompat_Light_Dialog:I

    invoke-direct {v0, v2, v3}, Landroid/support/v7/app/AlertDialog;-><init>(Landroid/content/Context;I)V
    ...
    invoke-virtual {v0, v2, v3, p0}, Landroid/support/v7/app/AlertDialog;->setButton(ILjava/lang/CharSequence;Landroid/content/DialogInterface$OnClickListener;)V
    ...
    invoke-virtual {v0, v2, v1, p0}, Landroid/support/v7/app/AlertDialog;->setButton(ILjava/lang/CharSequence;Landroid/content/DialogInterface$OnClickListener;)V
    ...
    sget v3, Landroid/support/v7/appcompat/R$style;->ThemeOverlay_AppCompat_Dialog:I
...
.method public onCreateView(Landroid/view/LayoutInflater;Landroid/view/ViewGroup;Landroid/os/Bundle;)Landroid/view/View;
    ...
    iput-object v0, p0, Landroid/support/v7/app/SeslColorPickerDialogFragment;->mColorPicker:Landroid/support/v7/widget/SeslColorPicker;
    ...
    .line 179
    const-string v0, "color_set_listener"

    invoke-virtual {v2, v0}, Landroid/os/Bundle;->getSerializable(Ljava/lang/String;)Ljava/io/Serializable;

    move-result-object v0

    check-cast v0, Landroid/support/v7/app/SeslColorPickerDialogFragment$OnColorSetListener;

    iput-object v0, p0, Landroid/support/v7/app/SeslColorPickerDialogFragment;->mOnColorSetListener:Landroid/support/v7/app/SeslColorPickerDialogFragment$OnColorSetListener;
    ...
    invoke-virtual {v0, v2}, Landroid/support/v7/widget/SeslRecentColorInfo;->setCurrentColor(Ljava/lang/Integer;)V

    .line 187
    :cond_1
    iget-object v0, p0, Landroid/support/v7/app/SeslColorPickerDialogFragment;->mNewColor:Ljava/lang/Integer;
    ...
    invoke-virtual {v0, v2}, Landroid/support/v7/widget/SeslRecentColorInfo;->setNewColor(Ljava/lang/Integer;)V

    .line 190
    :cond_2
    iget-object v0, p0, Landroid/support/v7/app/SeslColorPickerDialogFragment;->mRecentlyUsedColors:[I
    ...
    invoke-virtual {v0, v2}, Landroid/support/v7/widget/SeslRecentColorInfo;->initRecentColorInfo([I)V
    ...
    invoke-virtual {v0, v2}, Landroid/support/v7/widget/SeslColorPicker;->setOpacityBarEnabled(Z)V
    ...
    invoke-virtual {v0, v2}, Landroid/support/v7/widget/SeslColorPicker;->setOnColorChangedListener(Landroid/support/v7/widget/SeslColorPicker$OnColorChangedListener;)V
