...
.method public constructor <init>(Landroid/support/v7/widget/SeslDatePicker;Landroid/content/Context;Landroid/content/res/TypedArray;)V
    ...
    .line 2077
    sget v2, Landroid/support/v7/appcompat/R$color;->sesl_date_picker_saturday_week_text_color_light:I

    const/4 v3, 0x0

    invoke-static {v0, v2, v3}, Landroid/support/v4/content/a/b;->b(Landroid/content/res/Resources;ILandroid/content/res/Resources$Theme;)I

    move-result v0

    iput v0, p0, Landroid/support/v7/widget/SeslDatePicker$DayOfTheWeekView;->mSaturdayTextColor:I

    .line 2080
    const-string v0, "CscFeature_Calendar_SetColorOfDays"

    iget-object v2, p0, Landroid/support/v7/widget/SeslDatePicker$DayOfTheWeekView;->mDefaultWeekdayFeatureString:Ljava/lang/String;

    invoke-static {v0, v2}, Landroid/support/v4/a/a;->a(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;

    move-result-object v0

    iput-object v0, p0, Landroid/support/v7/widget/SeslDatePicker$DayOfTheWeekView;->mWeekdayFeatureString:Ljava/lang/String;
    ...
    iput-object v0, p0, Landroid/support/v7/widget/SeslDatePicker$DayOfTheWeekView;->mMonthDayLabelPaint:Landroid/graphics/Paint;

    .line 2084
    iget-object v0, p0, Landroid/support/v7/widget/SeslDatePicker$DayOfTheWeekView;->mMonthDayLabelPaint:Landroid/graphics/Paint;
    ...
    iget v2, p0, Landroid/support/v7/widget/SeslDatePicker$DayOfTheWeekView;->mNormalDayTextColor:I
...
.method protected onDraw(Landroid/graphics/Canvas;)V
    ...
    invoke-static {v0}, Landroid/support/v7/widget/SeslDatePicker;->access$4700(Landroid/support/v7/widget/SeslDatePicker;)I
    ...
    invoke-static {v0}, Landroid/support/v7/widget/SeslDatePicker;->access$4200(Landroid/support/v7/widget/SeslDatePicker;)I
    ...
    .line 2123
    iget-object v0, p0, Landroid/support/v7/widget/SeslDatePicker$DayOfTheWeekView;->mDayLabelCalendar:Ljava/util/Calendar;
    ...
    invoke-static {v0}, Landroid/support/v7/widget/SeslDatePicker;->access$4800(Landroid/support/v7/widget/SeslDatePicker;)Ljava/text/SimpleDateFormat;
