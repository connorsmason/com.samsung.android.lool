...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    sget v1, Landroid/support/v7/appcompat/R$attr;->actionButtonStyle:I
    ...
    iput v1, p0, Landroid/support/v7/widget/ActionMenuView;->mOriginalStartPadding:I
    ...
    iput v1, p0, Landroid/support/v7/widget/ActionMenuView;->mOriginalEndPadding:I
    ...
    sget v1, Landroid/support/v7/appcompat/R$string;->sesl_action_menu_overflow_badge_text_n:I
...
.method getSumOfDigitsInBadges()I
    ...
    .line 951
    invoke-virtual {v0}, Landroid/support/v7/view/menu/MenuItemImpl;->getBadgeText()Ljava/lang/String;

    move-result-object v0

    invoke-direct {p0, v0}, Landroid/support/v7/widget/ActionMenuView;->getNumericValue(Ljava/lang/String;)I
...
.method public invokeItem(Landroid/support/v7/view/menu/MenuItemImpl;)Z
    ...
    invoke-virtual {v1, p1, v0}, Landroid/support/v7/view/menu/MenuBuilder;->performItemAction(Landroid/view/MenuItem;I)Z
...
.method public onConfigurationChanged(Landroid/content/res/Configuration;)V
    ...
    invoke-virtual {v0, v3}, Landroid/support/v7/widget/ActionMenuPresenter;->updateMenuView(Z)V
...
.method protected onMeasure(II)V
    ...
    invoke-virtual {v0, v3}, Landroid/support/v7/view/menu/MenuBuilder;->onItemsChanged(Z)V
    ...
    .line 211
    iput v4, v0, Landroid/support/v7/widget/ActionMenuView$LayoutParams;->rightMargin:I

    iput v4, v0, Landroid/support/v7/widget/ActionMenuView$LayoutParams;->leftMargin:I

    .line 213
    instance-of v1, v2, Landroid/support/v7/view/menu/ActionMenuItemView;

    if-eqz v1, :cond_8

    .line 214
    iget v1, p0, Landroid/support/v7/widget/ActionMenuView;->mOriginalStartPadding:I

    iget v7, p0, Landroid/support/v7/widget/ActionMenuView;->mOriginalEndPadding:I

    invoke-virtual {v2, v1, v4, v7, v4}, Landroid/view/View;->setPaddingRelative(IIII)V
    ...
    .line 219
    iget v1, p0, Landroid/support/v7/widget/ActionMenuView;->mOriginalEndPadding:I
    ...
    invoke-virtual {v1, v3}, Landroid/support/v7/view/menu/ActionMenuItemView;->setIsLastItem(Z)V
    ...
    invoke-virtual {v1, v7}, Landroid/support/v7/view/menu/ActionMenuItemView;->setMinWidth(I)V

    .line 228
    invoke-virtual {v2, v0}, Landroid/view/View;->setLayoutParams(Landroid/view/ViewGroup$LayoutParams;)V

    .line 229
    iget v0, p0, Landroid/support/v7/widget/ActionMenuView;->mOriginalOverflowStartPadding:I

    iget v1, p0, Landroid/support/v7/widget/ActionMenuView;->mOriginalOverflowEndPadding:I
    ...
    invoke-virtual {v2, v4}, Landroid/support/v7/view/menu/ActionMenuItemView;->setIsLastItem(Z)V
    ...
    .line 238
    instance-of v0, v2, Landroid/support/v7/widget/ActionMenuPresenter$OverflowMenuButton;
    ...
    iget v1, p0, Landroid/support/v7/widget/ActionMenuView;->mOriginalOverflowStartPadding:I

    iget v7, p0, Landroid/support/v7/widget/ActionMenuView;->mOriginalOverflowEndPadding:I

    invoke-virtual {v0, v1, v4, v7, v4}, Landroid/view/View;->setPaddingRelative(IIII)V
    ...
    iget v1, p0, Landroid/support/v7/widget/ActionMenuView;->mOverflowButtonMinWidth:I
    ...
    .line 243
    iget v0, p0, Landroid/support/v7/widget/ActionMenuView;->mOverflowButtonMinWidth:I
