...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;II)V
    ...
    iput-object v2, p0, Landroid/support/v7/widget/SeslProgressBar;->mRefreshData:Ljava/util/ArrayList;

    .line 263
    iput v0, p0, Landroid/support/v7/widget/SeslProgressBar;->mCurrentMode:I

    .line 2286
    new-instance v2, Landroid/support/v7/widget/SeslProgressBar$1;

    const-string v3, "visual_progress"

    invoke-direct {v2, p0, v3}, Landroid/support/v7/widget/SeslProgressBar$1;-><init>(Landroid/support/v7/widget/SeslProgressBar;Ljava/lang/String;)V

    iput-object v2, p0, Landroid/support/v7/widget/SeslProgressBar;->VISUAL_PROGRESS:Landroid/util/FloatProperty;
    ...
    iput-wide v2, p0, Landroid/support/v7/widget/SeslProgressBar;->mUiThreadId:J

    .line 290
    invoke-direct {p0}, Landroid/support/v7/widget/SeslProgressBar;->initProgressBar()V

    .line 292
    sget-object v2, Landroid/support/v7/appcompat/R$styleable;->ProgressBar:[I
    ...
    .line 295
    iput-boolean v1, p0, Landroid/support/v7/widget/SeslProgressBar;->mNoInvalidate:Z
    ...
    :cond_0
    :goto_0
    sget v3, Landroid/support/v7/appcompat/R$styleable;->ProgressBar_android_indeterminateDuration:I

    iget v4, p0, Landroid/support/v7/widget/SeslProgressBar;->mDuration:I

    invoke-virtual {v2, v3, v4}, Landroid/content/res/TypedArray;->getInt(II)I

    move-result v3

    iput v3, p0, Landroid/support/v7/widget/SeslProgressBar;->mDuration:I

    .line 312
    sget v3, Landroid/support/v7/appcompat/R$styleable;->ProgressBar_android_minWidth:I

    iget v4, p0, Landroid/support/v7/widget/SeslProgressBar;->mMinWidth:I

    invoke-virtual {v2, v3, v4}, Landroid/content/res/TypedArray;->getDimensionPixelSize(II)I

    move-result v3

    iput v3, p0, Landroid/support/v7/widget/SeslProgressBar;->mMinWidth:I

    .line 313
    sget v3, Landroid/support/v7/appcompat/R$styleable;->ProgressBar_android_maxWidth:I
    ...
    iput v3, p0, Landroid/support/v7/widget/SeslProgressBar;->mMaxWidth:I

    .line 314
    sget v3, Landroid/support/v7/appcompat/R$styleable;->ProgressBar_android_minHeight:I

    iget v4, p0, Landroid/support/v7/widget/SeslProgressBar;->mMinHeight:I

    invoke-virtual {v2, v3, v4}, Landroid/content/res/TypedArray;->getDimensionPixelSize(II)I

    move-result v3

    iput v3, p0, Landroid/support/v7/widget/SeslProgressBar;->mMinHeight:I

    .line 315
    sget v3, Landroid/support/v7/appcompat/R$styleable;->ProgressBar_android_maxHeight:I
    ...
    iput v3, p0, Landroid/support/v7/widget/SeslProgressBar;->mMaxHeight:I

    .line 317
    sget v3, Landroid/support/v7/appcompat/R$styleable;->ProgressBar_android_indeterminateBehavior:I

    iget v4, p0, Landroid/support/v7/widget/SeslProgressBar;->mBehavior:I

    invoke-virtual {v2, v3, v4}, Landroid/content/res/TypedArray;->getInt(II)I

    move-result v3

    iput v3, p0, Landroid/support/v7/widget/SeslProgressBar;->mBehavior:I

    .line 319
    sget v3, Landroid/support/v7/appcompat/R$styleable;->ProgressBar_android_interpolator:I
    ...
    .line 323
    invoke-virtual {p0, p1, v3}, Landroid/support/v7/widget/SeslProgressBar;->setInterpolator(Landroid/content/Context;I)V

    .line 326
    :cond_1
    sget v3, Landroid/support/v7/appcompat/R$styleable;->ProgressBar_min:I

    iget v4, p0, Landroid/support/v7/widget/SeslProgressBar;->mMin:I

    invoke-virtual {v2, v3, v4}, Landroid/content/res/TypedArray;->getInt(II)I

    move-result v3

    invoke-virtual {p0, v3}, Landroid/support/v7/widget/SeslProgressBar;->setMin(I)V

    .line 327
    sget v3, Landroid/support/v7/appcompat/R$styleable;->ProgressBar_android_max:I

    iget v4, p0, Landroid/support/v7/widget/SeslProgressBar;->mMax:I

    invoke-virtual {v2, v3, v4}, Landroid/content/res/TypedArray;->getInt(II)I

    move-result v3

    invoke-virtual {p0, v3}, Landroid/support/v7/widget/SeslProgressBar;->setMax(I)V

    .line 329
    sget v3, Landroid/support/v7/appcompat/R$styleable;->ProgressBar_android_progress:I
    ...
    invoke-virtual {p0, v3}, Landroid/support/v7/widget/SeslProgressBar;->setProgress(I)V

    .line 331
    sget v3, Landroid/support/v7/appcompat/R$styleable;->ProgressBar_android_secondaryProgress:I

    iget v4, p0, Landroid/support/v7/widget/SeslProgressBar;->mSecondaryProgress:I

    invoke-virtual {v2, v3, v4}, Landroid/content/res/TypedArray;->getInt(II)I

    move-result v3

    invoke-virtual {p0, v3}, Landroid/support/v7/widget/SeslProgressBar;->setSecondaryProgress(I)V

    .line 334
    sget v3, Landroid/support/v7/appcompat/R$styleable;->ProgressBar_android_indeterminateDrawable:I
    ...
    .line 338
    invoke-virtual {p0, v3}, Landroid/support/v7/widget/SeslProgressBar;->setIndeterminateDrawableTiled(Landroid/graphics/drawable/Drawable;)V

    .line 344
    :cond_2
    :goto_1
    sget v3, Landroid/support/v7/appcompat/R$styleable;->ProgressBar_android_indeterminateOnly:I
    ...
    iput-boolean v3, p0, Landroid/support/v7/widget/SeslProgressBar;->mOnlyIndeterminate:Z

    .line 347
    iput-boolean v0, p0, Landroid/support/v7/widget/SeslProgressBar;->mNoInvalidate:Z

    .line 349
    iget-boolean v3, p0, Landroid/support/v7/widget/SeslProgressBar;->mOnlyIndeterminate:Z

    if-nez v3, :cond_3

    sget v3, Landroid/support/v7/appcompat/R$styleable;->ProgressBar_android_indeterminate:I

    iget-boolean v4, p0, Landroid/support/v7/widget/SeslProgressBar;->mIndeterminate:Z
    ...
    iget-boolean v3, p0, Landroid/support/v7/widget/SeslProgressBar;->mMirrorForRtl:Z
    ...
    invoke-direct {v0, v5}, Landroid/support/v7/widget/SeslProgressBar$ProgressTintInfo;-><init>(Landroid/support/v7/widget/SeslProgressBar$1;)V
    ...
    sget v3, Landroid/support/v7/appcompat/R$styleable;->ProgressBar_android_progressTintMode:I
    ...
    iput-object v3, v0, Landroid/support/v7/widget/SeslProgressBar$ProgressTintInfo;->mProgressTintMode:Landroid/graphics/PorterDuff$Mode;
    ...
    sget v3, Landroid/support/v7/appcompat/R$styleable;->ProgressBar_android_progressTint:I

    invoke-virtual {v2, v3}, Landroid/content/res/TypedArray;->getColorStateList(I)Landroid/content/res/ColorStateList;

    move-result-object v3

    iput-object v3, v0, Landroid/support/v7/widget/SeslProgressBar$ProgressTintInfo;->mProgressTintList:Landroid/content/res/ColorStateList;
    ...
    sget v3, Landroid/support/v7/appcompat/R$styleable;->ProgressBar_android_progressBackgroundTintMode:I
    ...
    iput-object v3, v0, Landroid/support/v7/widget/SeslProgressBar$ProgressTintInfo;->mProgressBackgroundTintMode:Landroid/graphics/PorterDuff$Mode;
    ...
    sget v3, Landroid/support/v7/appcompat/R$styleable;->ProgressBar_android_progressBackgroundTint:I

    invoke-virtual {v2, v3}, Landroid/content/res/TypedArray;->getColorStateList(I)Landroid/content/res/ColorStateList;

    move-result-object v3

    iput-object v3, v0, Landroid/support/v7/widget/SeslProgressBar$ProgressTintInfo;->mProgressBackgroundTintList:Landroid/content/res/ColorStateList;
    ...
    sget v3, Landroid/support/v7/appcompat/R$styleable;->ProgressBar_android_secondaryProgressTintMode:I
    ...
    iput-object v3, v0, Landroid/support/v7/widget/SeslProgressBar$ProgressTintInfo;->mSecondaryProgressTintMode:Landroid/graphics/PorterDuff$Mode;
    ...
    sget v3, Landroid/support/v7/appcompat/R$styleable;->ProgressBar_android_secondaryProgressTint:I

    invoke-virtual {v2, v3}, Landroid/content/res/TypedArray;->getColorStateList(I)Landroid/content/res/ColorStateList;

    move-result-object v3

    iput-object v3, v0, Landroid/support/v7/widget/SeslProgressBar$ProgressTintInfo;->mSecondaryProgressTintList:Landroid/content/res/ColorStateList;
    ...
    sget v3, Landroid/support/v7/appcompat/R$styleable;->ProgressBar_android_indeterminateTintMode:I
    ...
    iput-object v3, v0, Landroid/support/v7/widget/SeslProgressBar$ProgressTintInfo;->mIndeterminateTintMode:Landroid/graphics/PorterDuff$Mode;
    ...
    sget v3, Landroid/support/v7/appcompat/R$styleable;->ProgressBar_android_indeterminateTint:I

    invoke-virtual {v2, v3}, Landroid/content/res/TypedArray;->getColorStateList(I)Landroid/content/res/ColorStateList;

    move-result-object v3

    iput-object v3, v0, Landroid/support/v7/widget/SeslProgressBar$ProgressTintInfo;->mIndeterminateTintList:Landroid/content/res/ColorStateList;
    ...
    .line 433
    invoke-virtual {p0, v1}, Landroid/support/v7/widget/SeslProgressBar;->setImportantForAccessibility(I)V
    ...
    .line 340
    :cond_17
    invoke-virtual {p0, v3}, Landroid/support/v7/widget/SeslProgressBar;->setIndeterminateDrawable(Landroid/graphics/drawable/Drawable;)V
...
.method private static StateListDrawable_getStateCount(Landroid/graphics/drawable/StateListDrawable;)I
    ...
    .line 2262
    invoke-static {p0}, Landroid/support/v4/b/a/f;->a(Landroid/graphics/drawable/StateListDrawable;)I
...
.method private static StateListDrawable_getStateDrawable(Landroid/graphics/drawable/StateListDrawable;I)Landroid/graphics/drawable/Drawable;
    ...
    .line 2269
    invoke-static {p0, p1}, Landroid/support/v4/b/a/f;->a(Landroid/graphics/drawable/StateListDrawable;I)Landroid/graphics/drawable/Drawable;
...
.method private StateListDrawable_getStateSet(Landroid/graphics/drawable/StateListDrawable;I)[I
    ...
    .line 2276
    invoke-static {p1, p2}, Landroid/support/v4/b/a/f;->b(Landroid/graphics/drawable/StateListDrawable;I)[I
...
.method private declared-synchronized doRefreshProgress(IIZZZ)V
    ...
    :try_start_0
    iget v3, p0, Landroid/support/v7/widget/SeslProgressBar;->mMax:I
    ...
    .line 1354
    iget-object v3, p0, Landroid/support/v7/widget/SeslProgressBar;->mCurrentDrawable:Landroid/graphics/drawable/Drawable;
    ...
    invoke-static {v2, v4}, Landroid/support/v4/b/a/a;->b(Landroid/graphics/drawable/Drawable;I)Z
    ...
    .line 1397
    iget-object v2, p0, Landroid/support/v7/widget/SeslProgressBar;->VISUAL_PROGRESS:Landroid/util/FloatProperty;
    ...
    .line 1400
    sget-object v3, Landroid/support/v7/widget/SeslProgressBar;->PROGRESS_ANIM_INTERPOLATOR:Landroid/view/animation/DecelerateInterpolator;
    ...
    .line 1407
    invoke-virtual {p0, v7, p3, p2}, Landroid/support/v7/widget/SeslProgressBar;->onProgressRefresh(FZI)V
    :try_end_0
    ...
    .line 1366
    invoke-static {v2}, Landroid/support/v7/widget/SeslProgressBar;->StateListDrawable_getStateCount(Landroid/graphics/drawable/StateListDrawable;)I
    ...
    invoke-static {v2, v5}, Landroid/support/v7/widget/SeslProgressBar;->StateListDrawable_getStateDrawable(Landroid/graphics/drawable/StateListDrawable;I)Landroid/graphics/drawable/Drawable;
    ...
    .line 1377
    instance-of v10, v2, Landroid/graphics/drawable/LayerDrawable;
    ...
    .line 1381
    invoke-static {v2, v10}, Landroid/support/v4/b/a/a;->b(Landroid/graphics/drawable/Drawable;I)Z
    ...
    .line 1403
    :cond_c
    invoke-direct {p0, p1, v7}, Landroid/support/v7/widget/SeslProgressBar;->setVisualProgress(IF)V
    :try_end_2
...
.method private initProgressBar()V
    ...
    .line 587
    iput v1, p0, Landroid/support/v7/widget/SeslProgressBar;->mMin:I

    .line 588
    const/16 v0, 0x64

    iput v0, p0, Landroid/support/v7/widget/SeslProgressBar;->mMax:I

    .line 589
    iput v1, p0, Landroid/support/v7/widget/SeslProgressBar;->mProgress:I

    .line 590
    iput v1, p0, Landroid/support/v7/widget/SeslProgressBar;->mSecondaryProgress:I

    .line 591
    iput-boolean v1, p0, Landroid/support/v7/widget/SeslProgressBar;->mIndeterminate:Z

    .line 592
    iput-boolean v1, p0, Landroid/support/v7/widget/SeslProgressBar;->mOnlyIndeterminate:Z
    ...
    .line 595
    iput v2, p0, Landroid/support/v7/widget/SeslProgressBar;->mMinWidth:I

    .line 596
    iput v3, p0, Landroid/support/v7/widget/SeslProgressBar;->mMaxWidth:I

    .line 597
    iput v2, p0, Landroid/support/v7/widget/SeslProgressBar;->mMinHeight:I
...
.method private static needsTileify(Landroid/graphics/drawable/Drawable;)Z
    ...
    .line 462
    invoke-static {p0, v2}, Landroid/support/v7/widget/SeslProgressBar;->StateListDrawable_getStateDrawable(Landroid/graphics/drawable/StateListDrawable;I)Landroid/graphics/drawable/Drawable;
...
.method private declared-synchronized refreshProgress(IIZZ)V
    ...
    invoke-direct/range {v0 .. v5}, Landroid/support/v7/widget/SeslProgressBar;->doRefreshProgress(IIZZZ)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    .line 1477
    iget-boolean v0, p0, Landroid/support/v7/widget/SeslProgressBar;->mAttached:Z

    if-eqz v0, :cond_0

    iget-boolean v0, p0, Landroid/support/v7/widget/SeslProgressBar;->mRefreshIsPosted:Z
    ...
    iput-boolean v0, p0, Landroid/support/v7/widget/SeslProgressBar;->mRefreshIsPosted:Z
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
...
.method private tileify(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;
    ...
    sget v7, Landroid/support/v7/appcompat/R$id;->progress:I

    if-eq v0, v7, :cond_0

    sget v7, Landroid/support/v7/appcompat/R$id;->secondaryProgress:I
    ...
    :goto_1
    invoke-direct {p0, v6, v0}, Landroid/support/v7/widget/SeslProgressBar;->tileify(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;
    ...
    .line 537
    iget v1, p0, Landroid/support/v7/widget/SeslProgressBar;->mSampleWidth:I
    ...
    iput v1, p0, Landroid/support/v7/widget/SeslProgressBar;->mSampleWidth:I
...
.method private tileifyIndeterminate(Landroid/graphics/drawable/Drawable;)Landroid/graphics/drawable/Drawable;
    ...
    invoke-direct {p0, v3, v4}, Landroid/support/v7/widget/SeslProgressBar;->tileify(Landroid/graphics/drawable/Drawable;Z)Landroid/graphics/drawable/Drawable;
...
.method drawTrack(Landroid/graphics/Canvas;)V
    ...
    iget-object v5, p0, Landroid/support/v7/widget/SeslProgressBar;->mTransformation:Landroid/view/animation/Transformation;
    ...
    .line 1954
    iget-boolean v1, p0, Landroid/support/v7/widget/SeslProgressBar;->mShouldStartAnimationDrawable:Z
    ...
    .line 1956
    iput-boolean v6, p0, Landroid/support/v7/widget/SeslProgressBar;->mShouldStartAnimationDrawable:Z
...
.method public getPaddingRight()I
    ...
    .prologue
    .line 2257
    invoke-static {p0}, Landroid/support/v4/view/ab;->b(Landroid/view/View;)I
...
.method protected onAttachedToWindow()V
    ...
    .line 2099
    :cond_2
    iput-boolean v10, p0, Landroid/support/v7/widget/SeslProgressBar;->mAttached:Z
...
.method protected declared-synchronized onMeasure(II)V
    ...
    iget v2, p0, Landroid/support/v7/widget/SeslProgressBar;->mMaxWidth:I
    ...
    .line 1969
    iget v2, p0, Landroid/support/v7/widget/SeslProgressBar;->mMinHeight:I

    iget v3, p0, Landroid/support/v7/widget/SeslProgressBar;->mMaxHeight:I
...
.method public onResolveDrawables(I)V
    ...
    invoke-static {v0, v1}, Landroid/support/v4/b/a/a;->b(Landroid/graphics/drawable/Drawable;I)Z
...
.method public onRestoreInstanceState(Landroid/os/Parcelable;)V
    ...
    .line 2079
    iget v0, p1, Landroid/support/v7/widget/SeslProgressBar$SavedState;->secondaryProgress:I
...
.method public declared-synchronized setMax(I)V
    ...
    invoke-direct {p0, v0, v1, v2, v3}, Landroid/support/v7/widget/SeslProgressBar;->refreshProgress(IIZZ)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public declared-synchronized setProgress(I)V
    ...
    :try_start_0
    invoke-virtual {p0, p1, v0, v1}, Landroid/support/v7/widget/SeslProgressBar;->setProgressInternal(IZZ)Z
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public setProgressDrawable(Landroid/graphics/drawable/Drawable;)V
    ...
    .line 871
    sget v1, Landroid/support/v7/appcompat/R$id;->secondaryProgress:I
